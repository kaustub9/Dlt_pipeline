...
This folder defines all source code for the 'Test1_etl' pipeline:
...
* Take a look at the sample under "sample_users_test1_etl.py" to get familiar with the syntax.
